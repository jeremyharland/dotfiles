{ config, ... }: {
  ...
  #
  # Superwhisper's actual config (modes, replacements/vocabulary) lives in
  # its data folder at ~/superwhisper and is stowed from ../../superwhisper
  # instead — recordings/ and models/ stay untracked, only settings/ and
  # modes/ are in the repo.
